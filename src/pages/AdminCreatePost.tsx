        ...
        <div className="flex items-center gap-4 mb-12">
          ...
          <div>
            <h1 className="text-3xl font-display font-black text-white uppercase tracking-tight">
              Create <span className="text-neon-green">New Post</span>
            </h1>
            <p className="text-zinc-400 mt-1">Publish a new game mod or APK</p>
          </div>
        </div>
          ...
          <div className="bg-zinc-900/50 p-8 rounded-3xl border border-white/5 space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <input
                  ...
                  placeholder="e.g. GTA San Andreas Mod APK"
                />
              </div>
              <div>
            ...
            <div>
              ...
              <textarea
                ...
                placeholder="A brief summary of the game and mod features..."
              />
            </div>
